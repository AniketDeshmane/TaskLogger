...
namespace TaskLogger.Services
{
    public interface ITaskService
    {
        ...
        Task<List<TaskEntry>> SearchTasksAsync(string searchText, bool filterByCurrentMonth);
        ...
        Task ExportTasksAsync(string filePath, string format, bool filterByCurrentMonth);
